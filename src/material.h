...
class LinearMaterial<3> : public Material {
 public:
  ...
  LinearMaterial(double E, double nu) {
    ...
    stiffnesMatrix << c1, lambda, lambda, .0, .0, .0, lambda, c1, lambda, .0, .0, .0, lambda, lambda, c1, .0, .0, .0, .0, .0, .0, mu, .0,
...
class LinearMaterial<2> : public Material {
 public:
  ...
  LinearMaterial(double E, double nu) {
    stiffnesMatrix << 1.0, (precision)(nu), .0, (precision)(nu), 1.0, .0, 0.0, 0.0, (precision)((1.0 - nu) / 2.);
